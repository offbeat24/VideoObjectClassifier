...
public class CameraFragment extends Fragment {
    ...
    public CameraFragment(final ConnectionCallback callback,
    ...
    private void setupCameraOutputs(CameraManager manager) {
        try {
            ...
            if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                autoFitTextureView.setAspectRatio(previewSize.getWidth(),
                                                    previewSize.getHeight());
            } else {
                autoFitTextureView.setAspectRatio(previewSize.getHeight(),
